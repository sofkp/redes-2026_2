...
\begin{itemize}
    ...
    \begin{figure}[htbp]
        ...
        \caption{Ejecución del envío de datagramas UDP desde los equipos atacantes durante 15 segundos.}
        \label{fig:chk9-1}
    \end{figure}
    ...
    \begin{figure}[htbp]
        ...
        \caption{Uso de la red Wi-Fi en el equipo víctima durante el envío masivo de datagramas UDP.}
        \label{fig:chk9-2}
    \end{figure}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \caption{Gráfica de E/S de Wireshark en el equipo víctima, con un aumento de paquetes por segundo durante el ataque.}
    \label{fig:chk9-3}
\end{figure}
...
Un ataque de amplificación UDP combina suplantación de IP y un servidor de terceros que responde con más datos de los que recibe. El atacante envía una solicitud pequeña a un servidor DNS o NTP, pero coloca la dirección de la víctima como IP de origen. El servidor envía entonces su respuesta, más grande, a la víctima. Si el atacante repite el proceso con muchos servidores, las respuestas pueden generar un volumen de tráfico mucho mayor que el enviado inicialmente \cite{krupp2022ampfuzz}.
\end{enumerate}